<template>
  <svg :viewBox="`${props.xminmax[0]} ${props.yminmax[0]} ${props.xminmax[1]} ${props.yminmax[1]}`"
...
const props = defineProps(['points', 'xminmax', 'yminmax'])

const d = computed(() => {
  return svgPath(props.points, bezierCommandCalc)
})
